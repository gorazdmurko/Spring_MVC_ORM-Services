...
<body>
    ...
    <form:form method = "POST" action="submitStudent" modelAttribute="student" enctype="multipart/form-data">
        <table>
            <tr>
    ...
    <div>
        <h2 style="color: red;">Context: ${pageContext}</h2>
        <h2 style="color: red;">Request: ${pageContext.request}</h2>
        <h2 style="color: red;">CtxPath: ${pageContext.request.contextPath}</h2>
    </div>
</body>
