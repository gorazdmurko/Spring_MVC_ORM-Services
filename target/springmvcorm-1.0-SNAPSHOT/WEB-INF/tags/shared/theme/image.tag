...
<%@ attribute name="cssClasses" required="false" type="java.lang.String" %>
...
<img <c:if test="${not empty cssClasses }"> class="${cssClasses}"</c:if> src="${imageUrl}" alt="${alt}" title="${title}"/>